...
def get_mcie_relight(inputs):
    src_color = inputs      
    equ_hist = EqualizeHistTensor(src_color, limit=0.004)              
    equ_color = equ_hist(src_color)
    if len(equ_color.shape) != 4:
        equ_color = equ_color.unsqueeze(0)
    # print("equ_color",type(equ_color))
    sci_equ = equ_color
