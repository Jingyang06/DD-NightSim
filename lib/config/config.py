...
# cfg.multi_view_num = 3
# cfg.multi_view_max_angle = 15 #原来30，改为了45
cfg.multi_view_min_dis = 0.01
cfg.multi_view_max_dis = 1.5
...
# multi-view
cfg.optim.multi_view_ncc_weight= 0.15
cfg.optim.multi_view_geo_weight= 0.03
cfg.optim.multi_view_weight_from_iter= 0
cfg.optim.multi_view_patch_siz= 3
cfg.optim.multi_view_sample_num= 102400
cfg.optim.multi_view_pixel_noise_th= 1.0
