...
class StreetGaussianRenderer():
    ...
    def render_object(
        ...
        result = self.render_kernel(viewpoint_camera, pc, convert_SHs_python, compute_cov3D_python, scaling_modifier, override_color, white_background=True,return_plane=True)
    ...
    def render_sky(
        ...
        pc.parse_camera(viewpoint_camera)
        result = self.render_kernel(viewpoint_camera, pc, convert_SHs_python, compute_cov3D_python, scaling_modifier, override_color,return_plane=True)
        return result
    ...
    def render_kernel(
        ...
        rasterizer = make_rasterizer(viewpoint_camera, pc.max_sh_degree, bg_color, scaling_modifier,return_plane=True)
